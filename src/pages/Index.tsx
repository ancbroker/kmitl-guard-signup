    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-r from-primary to-white text-foreground pt-6 md:pt-8 lg:pt-10 xl:pt-12 pb-6 md:pb-8 lg:pb-10 xl:pb-12 shadow-[var(--shadow-medium)] relative overflow-hidden" >
        <div className="container mx-auto px-4 flex flex-col min-h-[26rem] md:min-h-0 lg:min-h-0">
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-12 lg:gap-8 xl:gap-12 items-center max-w-7xl mx-auto xl:max-w-none xl:grid-cols-1">
            {/* Left Side - Text Content */}
            <div className="space-y-4 md:space-y-8 lg:space-y-6 xl:space-y-8 text-center lg:text-left lg:pl-16 xl:pl-0 xl:max-w-2xl xl:mx-auto xl:z-10 xl:relative">
              <div>
            ...
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute top-20 right-24 animate-fade-in" style={{animationDelay: '0.2s'}}>
                  <Shield className="w-16 h-16 text-blue-500/30" strokeWidth={1.5} />
                </div>
                <div className="absolute bottom-40 right-12 animate-fade-in" style={{animationDelay: '0.4s'}}>
                  <Shield className="w-12 h-12 text-blue-400/35" strokeWidth={1.5} />
                </div>
                {/* Protective Circle Lines */}
