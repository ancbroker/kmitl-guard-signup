...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-r from-primary to-white text-foreground pt-6 md:pt-8 lg:pt-12 pb-0 shadow-[var(--shadow-medium)] relative overflow-hidden min-h-[24rem] md:min-h-[36rem] lg:min-h-[28rem] xl:min-h-[40rem]">
